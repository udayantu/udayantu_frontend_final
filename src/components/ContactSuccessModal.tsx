        ...
        <Card className="w-full max-w-2xl border border-primary/20 bg-gradient-to-br from-card/95 to-card/85 backdrop-blur-xl shadow-2xl overflow-hidden">
          ...
          <div className="relative p-8 pb-6 border-b border-primary/10">
            <button
              ...
              data-testid="button-close-contact-success"
              aria-label="Close"
            >
          ...
          <div className="p-8 space-y-6">
            {/* Confirmation box */}
            <div className={`space-y-3 transition-all duration-1000 delay-200 ${mounted ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}>
              <div className="p-4 rounded-xl bg-gradient-to-r from-primary/5 to-primary/0 border border-primary/20">
                <p className="text-xs text-muted-foreground mb-2 font-semibold uppercase tracking-wide">Name</p>
              ...
              <div className="p-4 rounded-xl bg-gradient-to-r from-secondary/5 to-secondary/0 border border-secondary/20">
                <p className="text-xs text-muted-foreground mb-2 font-semibold uppercase tracking-wide">Email</p>
                <p className="text-lg font-bold text-primary break-all">{email}</p>
              </div>
              <div className="p-4 rounded-xl bg-gradient-to-r from-accent/5 to-accent/0 border border-accent/20">
                <p className="text-xs text-muted-foreground mb-2 font-semibold uppercase tracking-wide">Category</p>
                <p className="text-lg font-bold text-foreground capitalize">{role}</p>
              </div>
            </div>

            {/* Status message */}
            <div className={`p-4 rounded-xl bg-gradient-to-r from-accent/10 to-accent/0 border border-accent/20 transition-all duration-1000 delay-300 ${
              mounted ? "opacity-100" : "opacity-0"
            }`}>
              <p className="text-sm text-foreground">
                <span className="font-semibold">What's next:</span> Our team will review your message and respond to your email within 24 hours.
              </p>
            </div>
            ...
            <div className={`flex flex-col sm:flex-row gap-3 transition-all duration-1000 delay-400 ${
              ...
              <Button
                ...
                asChild
                data-testid="button-explore-from-contact"
              >
